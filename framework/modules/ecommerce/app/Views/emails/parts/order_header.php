        ...
        <td>
            <table align="center" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation" style="border: none;">
                ...
                <tr style="width:100%">
                    ...
                    <td style="vertical-align: middle; width: 15%; text-align: right; border: 0;padding-right: 10px;">
                        <p style="white-space: nowrap; color: #94a3b8; text-align: right; margin: 0;font-size:12px;">Order Date</p>
            ...
            if ($orderTaxRates): ?>
                <div class="fct_invoice_tax_content" style="text-align: right;">
                    ...
                    if ($storeVatNumber !== '') {
                        echo '<p style="font-weight: 600; font-size: 14px;margin-bottom:12px;">' . TaxModule::getCountryTaxTitle($taxcountry) . ': ' . esc_html($storeVatNumber) . '</p>';
                    }
                    ?>
                </div>
            <?php endif; ?>
