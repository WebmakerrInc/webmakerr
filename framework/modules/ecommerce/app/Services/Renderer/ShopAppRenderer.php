...
//        ];
    ...
    public function render()
    {
        ...
        ?>
        <div class="fc-products-wrapper" data-fluent-cart-shop-app data-fluent-cart-product-wrapper role="main" aria-label="<?php esc_attr_e('Products', 'fluent-cart'); ?>">
    ...
    public function renderSortByFilter()
    {
        ...
        $dropdownId = 'fc-sort-dropdown-' . uniqid();
        ?>
        <div class="fc-shop-sorting-container">
            <button
                    class="fc-sorting-toggle"
                    data-sort-toggle
                    type="button"
                    aria-expanded="false"
                    aria-controls="<?php echo esc_attr($dropdownId); ?>"
                    aria-haspopup="true">
                <span class="fc-sorting-label"><?php echo esc_html__('Sort By', 'fluent-cart'); ?></span>

                <svg class="fc-sorting-arrow" xmlns="http://www.w3.org/2000/svg" width="14" height="8" viewBox="0 0 14 8" fill="none" aria-hidden="true" focusable="false">
                ...
                <fieldset class="fc-shop-sorting">
                    ...
                    <div class="fc-shop-sorting-item" data-sort-item role="none">
                        <label>
                            ...
                            <span class="fc-sorting-radio" aria-hidden="true"></span>
                            <span class="fc-sorting-radio-label">
    ...
    public function renderFilter($renderer)
    {
        ...
        ?>
        <?php if ($this->isFilterEnabled) : ?>
            <div class="fluent-cart-shop-app-filter-wrapper" data-fluent-cart-shop-app-filter-wrapper role="search" aria-label="<?php esc_attr_e('Product filters', 'fluent-cart'); ?>">
    ...
    public function renderPaginatorResultWrapper($atts = '')
    {
        ...
        $perPage = $this->products->perPage();
        ?>
        <div class="fc-shop-paginator-result-wrapper" aria-label="<?php echo esc_attr__('Pagination information', 'fluent-cart'); ?>">
            <div
                <?php echo !empty($atts) ? $atts : 'class="fc-shop-paginator-results wc-block-grid__fluent-cart-shop-app-paginator-results wp-block-fluent-cart-product-paginator-info"'; ?>
                    role="status"
                    aria-live="polite"
                    aria-atomic="true">
                <?php
                ...
                /* translators: 1: starting item number, 2: ending item number, 3: total number of items */
                    ...
                    '<span class="fc-shop-paginator-from" data-fluent-cart-shop-app-paginator-info-pagination-from="">' . esc_html($from) . '</span>',
                    '<span class="fc-shop-paginator-to" data-fluent-cart-shop-app-paginator-info-pagination-to="">' . esc_html($to) . '</span>',
                    '<span class="fc-shop-paginator-total" data-fluent-cart-shop-app-paginator-info-pagination-total="">' . esc_html($total) . '</span>'
                );
                ?>
            </div>

            <div class="fc-shop-per-page-selector">
                <label for="fc-per-page-select" class="screen-reader-text">
                    <?php echo esc_html__('Items per page', 'fluent-cart'); ?>
                </label>
                <select
                        id="fc-per-page-select"
                        name="per_page"
