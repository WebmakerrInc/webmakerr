...
class SearchBarRenderer
{
    ...
    public function renderResultItems($products = [])
    {
        ...
        foreach ($products as $product) {
            $productTitle = esc_html(Arr::get($product, 'post_title', ''));
            $productUrl = esc_url(Arr::get($product, 'guid', ''));
            ...
            ?>
                <li data-fluent-cart-search-bar-lists-list-item style="z-index: 9999;" role="listitem">
                    <a
                        ...
                        aria-label="<?php printf(esc_attr__('View product: %s', 'fluent-cart'), $productTitle); ?>"
                    >
