...
class CheckoutFieldsSchema
{
    ...
    public static function getAddressBaseFields($config, $scope = 'render')
    {
        ...
        if (empty($selectedCountry) && isset($_SERVER['HTTP_CF_IPCOUNTRY'])) {
            $selectedCountry = $_SERVER['HTTP_CF_IPCOUNTRY'];
        }
        ...
        $fields = [
            ...
            'address_1'    => [
                ...
                'data-type'    => 'text',
                'label'        => '',
                'aria-label'   => esc_attr__('House number and street name', 'fluent-cart'),
                /* translators: use local order of street name and house number. */
                'placeholder'  => esc_attr__('House number and street name *', 'fluent-cart'),
                'required'     => 'yes',
            ...
            'address_2'    => [
                ...
                'data-type'    => 'text',
                'label'        => '',
                'aria-label'   => esc_attr__('Apartment, suite, unit, etc. (optional)', 'fluent-cart'),
                'label_class'  => array(''),
                'placeholder'  => esc_attr__('Apartment, suite, unit, etc (optional)', 'fluent-cart'),
    ...
    public static function getFieldsSchemaConfig()
    {
        return [
            ...
            'billing_address'  => [
                ...
                'address_1' => [
                    'label'     => __('Address Line 1', 'fluent-cart'),
                    'type'      => 'text',
                    'can_alter' => 'yes',
                ],
                'address_2' => [
                    'label'     => __('Address Line 2', 'fluent-cart'),
                    'type'      => 'text',
                    'can_alter' => 'yes',
                ],
                'city'      => [
