...
class CartRenderer
{
    ...
    public function render()
    {
        ...
        <section class="fc-cart-page" aria-labelledby="fc-cart-page-title" role="region">
            <h2 id="fc-cart-page-title" class="screen-reader-text">
    ...
    public function renderItems()
    {
        ...
        <div class="fc-cart-drawer-content-wrapper" data-fluent-cart-cart-content-wrapper role="presentation">
            <?php $this->renderList(); ?>
        </div>
    ...
    public function renderList($items = [])
    {
        ...
        ?>
        <div class="fc-cart-drawer-list" data-fluent-cart-cart-list>
    ...
    public function renderDetails()
    {
        ...
        <div class="fc-cart-item-details" role="group" aria-label="<?php esc_attr_e('Product Details', 'fluent-cart'); ?>">
    ...
    public function renderTitles()
    {
        ...
        <h3 class="fc-cart-item-title" data-fluent-cart-cart-list-item-title>
            <a href="<?php echo esc_url($this->url); ?>"
               aria-label="<?php echo sprintf(esc_attr__('View %s', 'fluent-cart'), $postTitle); ?>"
    ...
    {
        ?>
        <div class="fc-cart-item-summary" role="group" aria-label="<?php esc_attr_e('Cart Item Summary', 'fluent-cart'); ?>">
    ...
    public function renderItemTotal()
    {
        ...
        <div class="fc-cart-item-total">
                <span
                    ...
                    aria-live="polite"
                    aria-label="<?php echo esc_attr(sprintf(__('Total price for this item: %s', 'fluent-cart'), $totalPrice)); ?>"
                >
        ...
        ?>
            ...
            >
                ...
                <span
                    ...
                    aria-live="polite"
                    aria-label="<?php echo esc_attr(sprintf(__('Total cart price: %s', 'fluent-cart'), $subtotal)); ?>"
                >
    ...
    public function renderEmpty()
    {
        ...
        <div
            ...
            role="region"
            aria-label="<?php esc_attr_e('Empty cart message', 'fluent-cart'); ?>"
        >
    ...
    { ?>
        <div class="fluent-cart-cart-empty-content-text">
            <?php esc_html_e('There is no items on your cart', 'fluent-cart'); ?>

            <a class="continue-shopping-link"
               href="<?php echo esc_url($this->storeSettings->getShopPage() ?? ''); ?>"
               aria-label="<?php esc_attr_e('Browse products and continue shopping', 'fluent-cart'); ?>">
                <?php esc_html_e('Continue Shopping', 'fluent-cart'); ?>
            </a>
        </div>
    <?php }
