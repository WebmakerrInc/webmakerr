...
{
    const SHORT_CODE = 'webmakerr_cart';
    protected static string $shortCodeName = 'webmakerr_cart';
    protected static array $aliases = ['fluent_cart_cart'];
    ...
    public static function register()
    {
        ...
        add_action('wp_enqueue_scripts', function () {
            ...
            if (static::shortcodeExistsInContent(get_the_content()) || has_block('fluent-cart/cart_cart')) {
