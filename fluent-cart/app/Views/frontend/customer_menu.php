...
<div class="fc-customer-dashboard-navs-wrap" role="navigation" aria-label="<?php esc_attr_e('Customer Dashboard', 'fluent-cart'); ?>">
    <?php if($profileData): ?>
    <div class="fc-customer-dashboard-customer-info" role="banner">
        ...
        <div id="fc-customer-logout-button">
            <a href="<?php echo esc_url(wp_logout_url(home_url())); ?>" title="Logout" class="fc-customer-logout-btn" aria-label="<?php esc_attr_e('Logout', 'fluent-cart'); ?>">
    ...
    <div id="menu-container">
        <button 
            id="fc-customer-menu-toggle"
            type="button"
            aria-expanded="false"
            aria-controls="fc-customer-menu-holder"
        ...
        <div id="fc-customer-menu-holder" aria-hidden="false">
            <div class="fc-customer-navs-wrap">
                <ul class="fc-customer-navs" role="list">
                    <?php foreach ($menuItems as $itemSlug => $menuItem): ?>
                        <li class="fc-customer-nav-item fc-customer-nav-item-<?php echo esc_attr($itemSlug); ?>" role="listitem">
                            <a
