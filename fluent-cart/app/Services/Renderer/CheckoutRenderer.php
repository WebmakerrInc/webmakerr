...
class CheckoutRenderer
{
    ...
    public function renderNotices()
    {
        ...
        ?>
        <div class="fc-cart-notices" role="status" aria-live="polite">
    ...
    protected function renderPaymentMethod($method, $config = [])
    {
        ...
        ?>
        <div
            class="fct_payment_method_logo fct_payment_method_wrapper fct_payment_method_<?php echo esc_attr($route); ?>"
            tabindex="0"
            role="presentation"
        >
            ...
            <div class="<?php echo "fluent-cart-checkout_embed_payment_container fluent-cart-checkout_embed_payment_container_" . esc_attr($route);?>" aria-hidden="true"></div>
        </div>
        <?php
    }
