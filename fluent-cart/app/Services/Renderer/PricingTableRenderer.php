...
class PricingTableRenderer
{
    ...
    public function render()
    {
        ...
        ?>
            <div class="fluent-cart-pricing-table" data-fluent-cart-pricing-table role="region" aria-label="<?php esc_attr_e('Pricing table', 'fluent-cart'); ?>">
                ...
                <div class="fluent-cart-pricing-table-variant-contents">
                    ...
                    <div class="fluent-cart-pricing-table-variant-price-wrap">
                        <div
                            ...
                            aria-label="<?php printf(esc_attr__('Price: %s%s per %s', 'fluent-cart'), $this->sign, $this->itemPrice, $this->repeatInterval ?? __('unit', 'fluent-cart')); ?>"
                        >
                        ...
                        <div class="fluent-cart-pricing-table-variant-compare-price">
                            ...
                            <span aria-label="<?php printf(esc_attr__('Compare at: %s%s', 'fluent-cart'), $this->sign, $this->comparePrice); ?>">
                    ...
                    <div class="fluent-cart-pricing-table-variant-payment-type">
                        ...
                        <span class="setup-fee" aria-label="<?php esc_attr_e('Setup fee information', 'fluent-cart'); ?>">
    ...
    public function renderOutOfStockButton() {
        ?>
            ...
            <button class="fc-out-of-stock-button" disabled aria-disabled="true" aria-label="<?php esc_attr_e('This item is out of stock and cannot be added to cart', 'fluent-cart'); ?>">
