...
class ProductFilterRender
{
    ...
    {
        ?>
        <form class="fc-shop-filter-form" data-fluent-cart-product-filter-form role="search" aria-label="<?php esc_attr_e('Product filter form', 'fluent-cart'); ?>">
    ...
    public function renderSearch() {
        ?>
        <div class="fc-shop-product-search" role="searchbox">
            <label for="fc-shop-search-input" class="sr-only">
        ...
        foreach ($this->filters as $key => $filter): ?>
            ...
            <?php if($filter['filter_type'] === 'options' && $filter['options']): ?>
                <div class="fc-shop-filter-item">
                    ...
                    <div
                        class="fc-shop-item-collapse-wrap"
                    ...
                    >
                        ...
                        <button type="button" class="toggle-icon" aria-label="<?php echo esc_attr__('Toggle filter', 'fluent-cart'); ?>">
                    ...
                    <div id="filter-<?php echo esc_attr($key); ?>" class="fc-shop-checkbox-group">
                        <?php
    ...
    public function renderCheckbox($option) {
        ...
        $checkboxId = 'fc-filter-' . esc_attr($key . '-' . $option['value']);
        ?>
            ...
            <div class="fc-shop-price-range-container" data-filter-type="range" data-filter-name="price_range">
                <div class="fc-shop-price-range-wrap">
                    <div class="fc-shop-price-range">
                        ...
                        <div class="fc-shop-currency-sign" aria-hidden="true">
                ...
                <small id="price-range-help" class="sr-only">
                    <?php printf(esc_html__('Price range in %s', 'fluent-cart'), esc_html($currencySign)); ?>
                </small>
            </div>
        </div>
        <?php
