...
class CartDrawerRenderer
{
    ...
    public function render(){
        ?>
            ...
            <div class="fc-cart-drawer-container" data-fluent-cart-cart-drawer-container role="complementary" aria-label="<?php esc_attr_e('Shopping Cart Drawer', 'fluent-cart'); ?>">
                <div
                        class="fc-cart-drawer-overlay <?php echo esc_attr($this->defaultOpenCart ? 'active' : '') ?>" data-fluent-cart-cart-drawer-overlay
                        tabindex="-1"
                ...
                <button class="fc-cart-drawer-open-btn <?php echo esc_attr($this->itemCount > 0 ? '' : 'is-hidden') ?>"
    ...
    {
        ?>
        <div class="fc-cart-drawer-loader" data-fluent-cart-cart-drawer-loader aria-hidden="true">
    ...
    {
        ?>
        <div class="fc-cart-badge-count" aria-live="polite">
            <?php
                if ($this->itemCount > 0) {
