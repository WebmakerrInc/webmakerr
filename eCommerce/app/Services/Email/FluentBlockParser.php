...
class FluentBlockParser
{
    ...
    public function renderOrderWrapper($innerBlocks, $attrs, $innerHTML)
    {
        ...
        return <<<HTML
<table class="fct_order_wrapper" role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0">
    <tr>
        <td style="padding: 0;">
            {$content}
        </td>
...
HTML;
    ...
    private function renderParagraph($block, $content, $attrs)
    {
        ...
        return <<<HTML
<table role="presentation" class="{$classAttr}" style="{$styleAttr}" width="100%" cellspacing="0" cellpadding="0" border="0">
    <tr>
        <td style="padding: 0;">
...
HTML;
    ...
    private function renderButtons($block, $innerBlocks, $attrs)
    {
        ...
        return <<<HTML
<table role="presentation" class="{$classAttr} fluent_buttons" style="{$styleAttr}" width="100%" cellspacing="0" cellpadding="0" border="0">
    <tr>
        <td style="padding: 0;">
            {$buttonsHtml}
        </td>
...
HTML;
    ...
    private function renderGroup($innerBlocks, $attrs, $innerHTML, $isRoot = false)
    {
        ...
        return <<<HTML
<table class="{$tableClass}" role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0">
    <tr>
        <td style="padding: 0;">
            {$content}
        </td>
