...
$receiptPageTemplateHandlerPath = FLUENTCART_PLUGIN_PATH . 'app/Hooks/Handlers/ReceiptPageTemplateHandler.php';
if (file_exists($receiptPageTemplateHandlerPath)) {
    require_once $receiptPageTemplateHandlerPath;
    if (class_exists('FluentCart\\App\\Hooks\\Handlers\\ReceiptPageTemplateHandler')) {
        (new \FluentCart\App\Hooks\Handlers\ReceiptPageTemplateHandler())->register();
    }
}
