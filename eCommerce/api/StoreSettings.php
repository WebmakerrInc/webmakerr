                            ...
                            'currency_position_grid' => [
                                ...
                                'schema'          => [
                                    ...
                                    'currency_position' => [
                                        ...
                                        "options"      => [
                                            [
                                                "label" => __('Symbool before (eg: $100)', 'fluent-cart'),
                                                "value" => 'before',
                                            ],
                                            [
                    ...
                    'cart_and_checkout'    => [
                        ...
                        'schema'          => [
                            "show_cart_icon_in_body" => [
                                ...
                                "type"  => "checkbox",
                                "value" => "yes",
                                'note'  => "<div class='pl-6'>" . __('<p>Display the cart icon in the body of the website</p> <p>Use this <code class="copyable-content" title="' . 'Copy to clipboard' . '">' . ('fcart-cart-toogle-button') . '</code> CSS class to display the cart link/icon anywhere else.</p>', 'fluent-cart') . "</div>"
                            ],
                            'hr2'                    => [
                                'type'  => 'html',
                                'value' => '<hr class="settings-devider">'
                                    ...
                                    'invoice_input_grid' => [
                                        ...
                                        'schema'          => [
                                            "min_receipt_number" => [
                                                ...
                                                "type"         => "input",
                                                "value"        => "",
                                                'note'         => "<div class=''>" . __('Next Receipt Number: ' . OrderService::getNextReceiptNumber(), 'fluent-cart') . "</div>"
                                            ],
                                            "inv_prefix"         => [
                                                'wrapperClass' => 'col-span-2 flex flex-col',
