...
<p class="wu-text-lg wu-text-gray-600 wu-my-4 wu-mb-6">
	<?php esc_html_e('You’ll need to get your', 'ultimate-multisite'); ?> <strong><?php esc_html_e('API Key', 'ultimate-multisite'); ?></strong> <?php esc_html_e('and', 'ultimate-multisite'); ?> <strong><?php esc_html_e('API Secret', 'ultimate-multisite'); ?></strong>, <?php esc_html_e('as well as find the', 'ultimate-multisite'); ?> <strong><?php esc_html_e('Server ID', 'ultimate-multisite'); ?></strong> <?php esc_html_e('and', 'ultimate-multisite'); ?> <strong><?php esc_html_e('APP ID', 'ultimate-multisite'); ?></strong> <?php esc_html_e('for your WordPress application', 'ultimate-multisite'); ?>.
</p>

<h3 class="wu-m-0 wu-py-4 wu-text-lg" id="step-1-getting-the-api-key-and-secret">
	<?php esc_html_e('Getting the API Key and API Secret', 'ultimate-multisite'); ?>
</h3>
...
<p class="wu-text-sm"><?php esc_html_e('On the new page, click in the', 'ultimate-multisite'); ?><b> <?php esc_html_e('API Key', 'ultimate-multisite'); ?> </b> <?php esc_html_e('menu item on the left', 'ultimate-multisite'); ?>.</p>
...
<p class="wu-text-center"><i><?php esc_html_e('Copy the API Key and API Secret values', 'ultimate-multisite'); ?></i></p>
